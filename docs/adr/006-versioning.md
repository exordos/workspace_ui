...
Monorepo with multiple packages (web, electron). Electron auto-updater and Sentry releases depend on consistent version numbers. Need a clear versioning policy.
