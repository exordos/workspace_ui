...
/** Cache/pin-store keys: API uuid, rail scope, and legacy aliases for «all» folder. */
function folderLookupKeys(apiFolderUuid: string, scopeFolderId?: string | null): string[] {
