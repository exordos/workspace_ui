/**
 * Parses effective Jitsi Meet base URL from the messenger API POST /api/v1/register JSON.
 *
 * Workspace exposes `jitsi_server_url` (combined, deprecated on FL 212+) or
