import type { MessagesPageResult, MockMessage, RawMessageToMockInput } from "./messenger.types";

export interface MessengerMessagesPageApiData {
  result?: string;
...
export function mapMessagesPageFromApiData(
  data: MessengerMessagesPageApiData,
