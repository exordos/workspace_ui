...
export const DEFAULT_MESSENGER_NOTIFICATION_SETTINGS: WorkspaceNotificationSettings = {
...
export function parseWorkspaceNotificationSettings(
  raw: Record<string, unknown> | null | undefined,
): WorkspaceNotificationSettings {
  if (raw == null) {
    return { ...DEFAULT_MESSENGER_NOTIFICATION_SETTINGS };
  }

  const defaults = DEFAULT_MESSENGER_NOTIFICATION_SETTINGS;
  return {
...
export function patchWorkspaceNotificationSettings(
  current: WorkspaceNotificationSettings,
  property: string,
  value: unknown,
): WorkspaceNotificationSettings {
  switch (property) {
