  ...
  return (
    ...
    >
      {outgoingBodyTrim.length === 0 ? (
        ...
        <div
          className="composer-preview-html message-body min-w-0 max-w-full break-words [&_a]:text-accent [&_a]:underline hover:[&_a]:opacity-90 [&_blockquote]:border-l-2 [&_blockquote]:border-border-subtle [&_blockquote]:pl-2 [&_blockquote]:italic [&_blockquote]:text-text-muted [&_img]:my-1 [&_img]:h-auto [&_img]:max-w-full [&_img]:rounded [&_p:last-child]:mb-0 [&_p]:mb-1 [&_pre]:my-1 [&_pre]:max-w-full [&_pre]:min-w-0 [&_pre]:border-l-2 [&_pre]:border-border-subtle [&_pre]:pl-2 [&_pre]:pr-2 [&_pre]:py-2 [&_pre]:italic [&_pre]:text-text-muted [&_pre]:text-sm [&_pre]:font-mono [&_pre]:whitespace-pre-wrap [&_pre]:[overflow-wrap:anywhere] [&_pre_code]:max-w-full [&_pre_code]:min-w-0 [&_pre_code]:whitespace-pre-wrap [&_pre_code]:[overflow-wrap:anywhere] [&_span.user-mention]:text-accent hover:[&_span.user-mention]:opacity-90 [&_table]:my-2 [&_table]:w-full [&_table]:border-collapse [&_table]:text-sm [&_td]:border [&_td]:border-border-subtle [&_td]:px-2 [&_td]:py-1 [&_th]:border [&_th]:border-border-subtle [&_th]:px-2 [&_th]:py-1 [&_th]:text-left"
