    ...
    <div className="relative h-5 min-w-5 shrink-0" data-testid="sidebar-chat-row-action-slot">
      ...
      {hasExpandChevron && (
        <button
          ...
          className="bg-bg/60 hover:bg-bg-elevated/80 absolute inset-0 z-10 hidden items-center justify-center rounded-lg text-text-muted hover:text-text-primary focus-visible:text-text-primary group-focus-within/stream:flex group-hover/stream:flex"
