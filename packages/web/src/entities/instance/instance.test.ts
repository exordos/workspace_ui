...
describe("instancesStore", () => {
  ...
  describe("addInstance", () => {
    ...
    it("returns duplicate for the same normalized realm and email", () => {
      ...
      expect(useInstancesStore.getState().instances[0]?.iamAccessToken).toBe("k1");
    });
