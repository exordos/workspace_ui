...
export function adaptMessengerStream(dto: WorkspaceMessengerStreamDto): MessengerStream {
  return {
    ...
    activeUnreadCount: dto.active_unread_count ?? dto.unread_count,
    passiveUnreadCount: dto.passive_unread_count ?? 0,
...
export function adaptStreamToMessengerConversation(
  ...
  return {
    ...
    activeUnreadCount: stream.active_unread_count ?? stream.unread_count,
    passiveUnreadCount: stream.passive_unread_count ?? 0,
...
export function adaptTopicToMessengerConversation(
  ...
  return {
    ...
    activeUnreadCount: topic.active_unread_count ?? topic.unread_count,
    passiveUnreadCount: topic.passive_unread_count ?? 0,
    isArchived: stream.is_archived,
    directUserUuid: stream.direct_user_uuid ?? null,
