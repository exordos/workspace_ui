...
const BASE_BODY_CLASS_NAME = [
  ...
  "[&_.workspace-message-image-composition]:inline-flex",
  "[&_.workspace-message-image-composition]:max-w-full",
  "[&_.workspace-message-image-composition]:flex-wrap",
  "[&_.workspace-message-image-composition]:gap-1",
  "[&_.workspace-message-image-composition]:align-middle",
  "[&_.workspace-message-file-placeholder--composition]:!my-0",
  "[&_.workspace-message-file-placeholder--composition]:!h-[100px]",
  "[&_.workspace-message-file-placeholder--composition]:!max-w-full",
  ...
  "[&_.workspace-message-file-preview-loaded.workspace-message-file-placeholder--composition[data-workspace-media-kind='image']]:!max-h-[100px]",
  "[&_.workspace-message-file-preview-loaded.workspace-message-file-placeholder--composition[data-workspace-media-kind='image']]:!h-[100px]",
  "[&_.workspace-message-file-preview-loaded.workspace-message-file-placeholder--composition[data-workspace-media-kind='image']_.workspace-message-file-preview-image]:!max-h-[100px]",
  "[&_.workspace-message-file-preview-loaded.workspace-message-file-placeholder--composition[data-workspace-media-kind='image']_.workspace-message-file-preview-image]:!h-auto",
