...
// src/unread-indicator.lib.ts
var unread_indicator_lib_exports = {};
__export(unread_indicator_lib_exports, {
  ...
  UNREAD_DOT_RADIUS_FRACTION: () => UNREAD_DOT_RADIUS_FRACTION,
  UNREAD_INDICATOR_COLOR: () => UNREAD_INDICATOR_COLOR,
  compositeUnreadDotOnNativeImage: () => compositeUnreadDotOnNativeImage,
  createUnreadDotOverlaySvg: () => createUnreadDotOverlaySvg,
  getDockUnreadDotInsets: () => getDockUnreadDotInsets,
  getUnreadDotRadiusPx: () => getUnreadDotRadiusPx
});
module.exports = __toCommonJS(unread_indicator_lib_exports);
var UNREAD_INDICATOR_COLOR = "#FF5500";
var UNREAD_DOT_RADIUS_FRACTION = 80 / 680;
var TRAY_UNREAD_DOT_RADIUS_FRACTION = 68 / 680;
var DOCK_UNREAD_DOT_RADIUS_FRACTION = 56 / 680;
var DOCK_UNREAD_DOT_MARGIN_FRACTION = 32 / 680;
function getUnreadDotRadiusPx(iconSizePx, fraction = UNREAD_DOT_RADIUS_FRACTION) {
...
function createUnreadDotOverlaySvg(sizePx, fraction = UNREAD_DOT_RADIUS_FRACTION) {
